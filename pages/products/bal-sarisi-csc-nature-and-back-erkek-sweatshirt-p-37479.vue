...
const productImages = ref([
  { large: "https://img-phantomcolumbia.mncdn.com/mnresize/247/-/img/assets/base/originals/CS0329_756-0-240924074019781.jpg", thumb: "https://img-phantomcolumbia.mncdn.com/mnresize/24/-/img/colors/bal-sarisi_1109-231107193323920.jpeg" }
])
const discountPercentage = 45
const selectedSize = ref('M')
const stockCount = ref(5)
const cartCount = ref(91)

const selectedColor = ref(product.value.colors[1])

const sizes = ref([ 'S', 'M', 'L', 'XL', '2XL', '3XL' ])
